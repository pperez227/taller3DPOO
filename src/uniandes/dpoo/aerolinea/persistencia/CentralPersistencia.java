...
public class CentralPersistencia
{
     ...
     */
    public static PersistenciaAerolinea getPersistenciaAerolinea( String tipoArchivo ) throws IOException
    {
        if (JSON.equals(tipoArchivo)) {
            ...
            throw new IOException (tipoArchivo);
        }
    }
     ...
     * @throws TipoInvalidoException Se lanza esta excepción si se utiliza un tipo de archivo que no es válido
     */
    public static PersistenciaTiquetesJson getPersistenciaTiquetes( String tipoArchivo ) throws IOException
    {
        if( JSON.equals( tipoArchivo ) )
